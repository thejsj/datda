...
var validateInput = function (opts) {
   ...
   */
  if (typeof opts.mongodb === 'object') {
    opts.mongodb = _.defaults(opts.mongodb, {
      host: 'localhost',
      port: 27017,
    });
  }
  ...
  if (opts.db === undefined && (opts.rethinkdb.db === undefined || opts.mongodb.db === undefined)) {
