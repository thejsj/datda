...
RethinkDBClient.prototype.getTables = function () {
  return r.tableList().run(this.conn)
    .then(function (tableNames) {
      return Promise.all(tableNames.map(function (table) {
...
RethinkDBClient.prototype.getRows = function (tableConfig, numberOfRows, offset) {
  var options = {};
  if(this.connectionOpts.arrayLimit)
    options.arrayLimit = this.connectionOpts.arrayLimit;
 ...
 * @return <Object>
 */
RethinkDBClient.prototype.mapImportedRow = function (tableConfig, row) {
  return row;
};
 ...
 * @return <Object>
 */
RethinkDBClient.prototype.mapExportedRow = function (tableConfig, row) {
  return row;
};
